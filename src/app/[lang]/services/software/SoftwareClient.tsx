...
import { ArrowLeft, Globe, ShoppingCart, Smartphone, Link2, Database, RefreshCw, Palette, Server, Wrench } from "lucide-react";
...
export default function SoftwareClient({ dict, lang }: LocalizedComponentProps) {
  ...
  const services = [
    {
      ...
      description: isArabic ? 'إنشاء مواقع فريدة ومتجاوبة مصممة خصيصًا لرؤية علامتك التجارية وأهداف عملك.' : 'Crafting unique, responsive websites tailored to your brand\'s vision and business goals.',
      color: 'cyan',
    },
    {
      icon: ShoppingCart,
      title: isArabic ? 'تطوير التجارة الإلكترونية' : 'E-commerce Development',
      description: isArabic ? 'تطوير متاجر آمنة وقابلة للتوسع عبر الإنترنت تزيد المبيعات وتعزز تجربة العملاء.' : 'Developing secure and scalable online stores that drive sales and enhance customer experience.',
      color: 'emerald',
    },
    {
      icon: Smartphone,
      title: isArabic ? 'تطبيقات الويب التقدمية (PWAs)' : 'Progressive Web Apps (PWAs)',
      description: isArabic ? 'بناء تطبيقات ويب توفر تجربة تطبيق أصلية مع قدرات غير متصلة وإشعارات دفع.' : 'Building web applications that offer a native app experience with offline capabilities and push notifications.',
      color: 'purple',
    },
    {
      icon: Link2,
      title: isArabic ? 'تطوير ودمج API' : 'API Development & Integration',
      description: isArabic ? 'إنشاء واجهات برمجية قوية ودمج خدمات طرف ثالث لتعزيز الوظائف وتدفق المستخدم.' : 'Creating robust APIs and integrating third-party services to enhance functionality and user flow.',
      color: 'orange',
    },
    {
      icon: Database,
      title: isArabic ? 'أنظمة إدارة المحتوى (CMS)' : 'Content Management Systems (CMS)',
      description: isArabic ? 'تنفيذ حلول CMS مرنة لـ WordPress أو Drupal أو أنظمة مخصصة لتحديثات المحتوى السهلة.' : 'Implementing flexible CMS solutions for WordPress, Drupal, or custom-built systems for easy content updates.',
      color: 'cyan',
    },
    {
      icon: RefreshCw,
      title: isArabic ? 'إعادة تصميم وتحسين المواقع' : 'Website Redesign & Optimization',
      description: isArabic ? 'تجديد المواقع الحالية للحصول على جماليات حديثة وأداء محسّن وتجربة مستخدم أفضل.' : 'Revamping existing websites for modern aesthetics, improved performance, and better user experience.',
      color: 'purple',
    },
    {
      icon: Palette,
      title: isArabic ? 'تصميم UI/UX للويب' : 'UI/UX Design for Web',
      description: isArabic ? 'تصميم واجهات مستخدم بديهية وجذابة وجذابة بصريًا تعزز تجارب المستخدم.' : 'Designing intuitive, engaging, and visually appealing user interfaces and user experiences.',
      color: 'yellow',
    },
    {
      icon: Server,
      title: isArabic ? 'تطوير بوابات الويب' : 'Web Portal Development',
      description: isArabic ? 'بناء بوابات ويب آمنة وفعالة للموظفين أو العملاء أو الشركاء مع وظائف مخصصة.' : 'Building secure and efficient web portals for employees, customers, or partners with custom functionality.',
      color: 'cyan',
    },
    {
      icon: Wrench,
      title: isArabic ? 'صيانة ودعم المواقع' : 'Website Maintenance & Support',
      description: isArabic ? 'صيانة مستمرة وتحديثات أمنية ودعم تقني لضمان تشغيل موقعك بسلاسة.' : 'Ongoing maintenance, security updates, and technical support to ensure your website runs smoothly.',
      color: 'pink',
    },
  ];
  ...
  const technologies = [
    {
      name: 'React.js',
      description: isArabic ? 'مكتبة JavaScript لبناء واجهات المستخدم.' : 'A JavaScript library for building user interfaces.',
      iconPath: (
    ...
    {
      name: 'Node.js',
      description: isArabic ? 'بيئة تشغيل JavaScript مبنية على محرك Chrome V8 JavaScript.' : 'A JavaScript runtime built on Chrome\'s V8 JavaScript engine.',
      iconPath: (
    ...
    },
    {
      ...
      description: isArabic ? 'أطر عمل قوية لتطوير الويب السريع وواجهات برمجة التطبيقات.' : 'Powerful frameworks for rapid web development and APIs.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Laravel',
      description: isArabic ? 'إطار عمل PHP أنيق لبناء تطبيقات ويب قوية.' : 'An elegant PHP framework for building robust web applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Next.js',
      description: isArabic ? 'إطار عمل React لتطبيقات الويب على مستوى الإنتاج.' : 'A React framework for production-grade web applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Vue.js',
      description: isArabic ? 'إطار عمل تقدمي لبناء واجهات المستخدم.' : 'A progressive framework for building user interfaces.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          <path d="M24 1.61h-4.8L12 14.87 4.8 1.61H0l12 20.78 12-20.78zM4.8 1.61h4.8L12 6.62l2.4-5.01h4.8L12 15.88 4.8 1.61z"/>
        </svg>
      ),
      color: 'emerald',
    },
    {
      name: 'Angular',
      description: isArabic ? 'منصة لبناء تطبيقات عميل أحادية الصفحة.' : 'A platform for building single-page client applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'MongoDB',
      description: isArabic ? 'قاعدة بيانات NoSQL شهيرة لتطبيقات الويب الحديثة.' : 'A popular NoSQL database for modern web applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'PostgreSQL',
      description: isArabic ? 'قاعدة بيانات علائقية قوية ومفتوحة المصدر.' : 'A powerful, open source object-relational database system.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'AWS',
      description: isArabic ? 'خدمات حوسبة سحابية رائدة لبنية تحتية ويب قابلة للتوسع.' : 'Leading cloud computing services for scalable web infrastructure.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Azure',
      description: isArabic ? 'منصة الحوسبة السحابية من Microsoft لبناء ونشر التطبيقات.' : 'Microsoft\'s cloud computing platform for building and deploying applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Docker',
      description: isArabic ? 'منصة لتطوير وشحن وتشغيل التطبيقات باستخدام الحاويات.' : 'Platform for developing, shipping, and running applications using containerization.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'Kubernetes',
      description: isArabic ? 'نظام مفتوح المصدر لأتمتة نشر وإدارة التطبيقات المحتواة.' : 'An open-source system for automating deployment and management of containerized applications.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'GraphQL',
      description: isArabic ? 'لغة استعلام لواجهات برمجة التطبيقات ووقت تشغيل لبناء تلك الواجهات.' : 'A query language for APIs and a runtime for building those APIs.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    {
      name: 'RESTful APIs',
      description: isArabic ? 'معيار لتصميم تطبيقات الشبكة لتواصل بيانات فعال.' : 'Standard for designing networked applications for efficient data communication.',
      iconPath: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  const getColorClasses = (color: string) => {
    const colors: Record<string, { border: string; icon: string; accent: string }> = {
      ...
      red: { border: 'border-red-400/20', icon: 'text-red-400', accent: 'bg-red-400/10' },
      white: { border: 'border-gray-400/20', icon: 'text-white', accent: 'bg-gray-400/10' },
      gray: { border: 'border-gray-400/20', icon: 'text-gray-400', accent: 'bg-gray-400/10' },
    };
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center ${isArabic ? 'lg:grid-flow-dense' : ''}`}>
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                  {isArabic ? 'بناء الأسس الرقمية' : 'Building Digital Foundations'}
                </span>
                <br />
            ...
            >
              <div className="relative p-8 rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-900/20 via-blue-900/10 to-transparent backdrop-blur-sm">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-4" dir={isArabic ? 'rtl' : 'ltr'}>
        ...
        <div className="container mx-auto max-w-[96%]">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                {isArabic ? 'خدمات تطوير الويب الشاملة' : 'Our Full-Spectrum Web Development Services'}
              </span>
            </h2>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              <span className="bg-gradient-to-r from-yellow-400 via-orange-400 to-yellow-400 bg-clip-text text-transparent">
                {isArabic ? 'التقنيات والأطر الأساسية' : 'Our Core Technologies & Frameworks'}
              </span>
            </h2>
            <p className="text-gray-400 max-w-3xl mx-auto">
              {isArabic 
            ...
            {technologies.map((tech, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group p-6 rounded-xl border ${colors.border} bg-[#141b2d]/80 backdrop-blur-sm hover:bg-[#1a2332] transition-all duration-300 text-center`}
                >
                  <div className={`mb-3 flex items-center justify-center ${colors.icon}`}>
                    {tech.iconPath}
                  </div>
