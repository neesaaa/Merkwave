  ...
  const fakeData: Project[] = [
    {
      ...
      codeUrl: 'https://github.com/example1',
    },
    {
      id: 2,
      slug: 'project-2',
    ...
    },
    {
      ...
      codeUrl: 'https://github.com/example3',
    },
    {
      id: 4,
      slug: 'project-4',
      titleEn: 'Branding Campaign',
      titleAr: 'حملة العلامة التجارية',
      client_id: 104,
      client_name: 'Client D',
      project_date: '2025-04-01',
      category: 'BRANDING',
      featured: 0,
      imageUrl: '/media.png',
    ...
    },
    {
      id: 7,
      slug: 'project-7',
      titleEn: 'Media Production Video',
      titleAr: 'إنتاج فيديو',
      client_id: 107,
